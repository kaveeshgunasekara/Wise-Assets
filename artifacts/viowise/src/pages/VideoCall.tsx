      ...
      <header className="absolute top-0 w-full p-6 flex justify-between items-start z-20 bg-gradient-to-b from-[#17141F]/80 to-transparent">
        ...
        <div className="flex flex-col items-end gap-2">
          <button 
            ...
            className={`px-3 py-1.5 rounded-full text-base font-medium border ${subtitlesOn ? 'bg-white/20 border-white/30' : 'bg-black/40 border-white/10'}`}
          >
            Live subtitles: {subtitlesOn ? "On" : "Off"}
          </button>
          <div className="px-3 py-1.5 bg-[#A594E8]/20 border border-[#A594E8]/40 text-[#A594E8] rounded-full text-base font-medium flex items-center gap-1.5">
