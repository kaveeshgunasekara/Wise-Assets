  ...
  <div class="min-h-screen bg-pattern relative overflow-hidden flex flex-col">
    ...
    <header class="relative px-6 py-4 flex items-center justify-between z-20">
      <router-link to="/" class="flex items-center gap-2">
        <img src="/logo.png" alt="Viowise" class="h-12 w-auto" />
      </router-link>
      <div class="flex gap-4 items-center">
        <router-link to="/sign-in" class="px-4 py-2 font-medium text-white/90 hover:text-white transition-colors">Sign in</router-link>
    ...
    <footer class="mt-auto py-8 text-center text-white/60 text-[16px] flex items-center justify-center gap-2 z-10">
