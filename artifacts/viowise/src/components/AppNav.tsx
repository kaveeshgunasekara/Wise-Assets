      ...
      <div className="px-4 sm:px-6 py-3 flex items-center justify-between md:grid md:grid-cols-3">
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3">
          ...
          <div className="relative hidden md:block">
            ...
            {profileMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-52 bg-white border border-border shadow-lg rounded-xl py-2 z-50">
                <Link href="/profile" onClick={() => setProfileMenuOpen(false)} className="block px-4 py-3 hover:bg-secondary">
                  Profile
                </Link>
                <button
                  onClick={() => { setProfileMenuOpen(false); openBanner(); }}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-border bg-white">
          ...
          <div className="px-4 py-2 border-t border-border">
            ...
            <button
              onClick={() => { closeMobile(); openBanner(); }}
